...
const page = () => {
  ...
  const { register, handleSubmit } = useForm<schema>({ resolver: zodResolver(registerSchema) })
  const onSubmit: SubmitHandler<schema> = (data) => console.log(data)

  return (
    <div className="flex flex-col m-24 items-center justify-center mx-auto  md:h-screen h-full lg:py-0">
      <div
        onClick={() => {
          router.push('/')
        }}
